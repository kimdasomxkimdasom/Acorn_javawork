...
public class MainFrame05 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		//Runnable 인터페이스 type의 참조값을 얻어내서
		Runnable downTask=new DownloadTask(); //Runnable type
		Thread t=new Thread(downTask); //Thread type
		t.start();
	...
	public static void main(String[] args) {
		MainFrame05 f = new MainFrame05("메인프레임 01");

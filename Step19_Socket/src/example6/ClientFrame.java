...
public class ClientFrame extends JFrame 
	...
	public ClientFrame(String title) {
		...
		Vector<String> enterList=new Vector<String>();
	...
	public void connect() {
		...
		try {
			...
			//JSONobject에 담긴 정보를 JSON 문자열로 만들어서
		...
		public void run() {
			while(true) {
				try {
					...
					if(type.equals("enter")) { //java에서 문자열 비교는 ==이 아니고 equals
